jQuery(window).ready(function ($) {
	...
	$('#blog-nav-container > ul a').each(function () {
	...
	$('#blog-nav-container a').click(function (e) {
		/* Finding the drop down list that corresponds to the current section: */
	...
	var filterText = "Filter by...";

	$('#blog-nav-container > ul').mobileMenu({
	...
	// Mobile menu styling
	$('#blog-nav-container select').each(function () {

		$(this).css({ 'z-index': 10, 'opacity': 0, '-khtml-appearance': 'none' }).after('<span class="select">' + filterText + '<i class="icon-menu"></i></span>');
	});
	...
	function checkWidth() {
		...
		// if (windowsize <= 768) {
		// 	$('img[alt="Logo"]').attr("src", "images/logo@2mobile.png");
		// } else {
		// 	$('img[alt="Logo"]').attr("src", "images/logo.png");
		// }
